...
<div id="main_bill1">
    <div id="content_printdown">
        ...
        <input type="hidden" value="{{$fetch_data->dispatch_no}}" name="dispatch" id="dispatch">
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    <td align="left"
                                                                        ...
                                                                        width="50%"> <span
                                                                            style="display: block; margin-bottom: 5px;">Despatch Order
                                                                            </span>
                                                                        <strong>{{$fetch_data->dispatch_no}}</strong>
                                                                        <br />
                                                                        <span
                                                ...
                                                @foreach ($fetch_data->details as $sdata)
                                                    <tr>
                                                        ...
                                                        <td style="text-align: center; font-size: 13px; font-family: 'Open Sans', sans-serif; color: #1a1919;  line-height: 23px;  vertical-align: top; padding:10px; border-left: 1px solid #e4e4e4;"
                                                            ...
                                                            <td style="text-align: center; font-size: 13px; font-family: 'Open Sans', sans-serif; color: #1a1919;  line-height: 23px;  vertical-align: top; padding:10px; border-left: 1px solid #e4e4e4;"
                                                            align="right">{{ $sdata->sale_price}}</td>
                                                        <td style="text-align: center; font-size: 13px; font-family: 'Open Sans', sans-serif; color: #1a1919;  line-height: 23px;  vertical-align: top; padding:10px; border-left: 1px solid #e4e4e4;"
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td style="font-size: 13px; font-family: 'Open Sans', sans-serif; color: #1a1919; line-height: 27px; vertical-align: top; text-align:right; white-space:nowrap;"
                                                        width="80">
                                                        ₹{{ $fetch_data->details[0]->total_amount }}
                                                    </td>
                                                </tr>
                                                {{-- <tr>
                                                    <td
                                                ...
                                                <tr>
                                                    ...
                                                    <td
                                                        style="font-size: 15px; font-family: 'Open Sans', sans-serif; color: #1a1919; line-height: 31px; vertical-align: top; text-align:right; padding-top: 7px; border-top: 1px solid #e4e4e4;">
                                                        <strong> ₹{{ $fetch_data->paid_amount }}</strong>
                                                    </td>
                                                </tr>
                                                <!--
                                <tr>
...
<script>
    ...
    function printthispage() {
        var invoiceElement = document.getElementById('dispatch');
