...
<div id="main_bill1">
    <div id="content_printdown">
        ...
        <input type="hidden" value="{{$fetch_data->po_no}}" name="purchaes" id="purchaes">
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    <td align="left"
                                                                        ...
                                                                        width="50%"> <span
                                                                            style="display: block; margin-bottom: 5px;">Purchase Order
                                                                            </span>
                                                                        <strong>{{$fetch_data->po_no}}</strong>
                                                                        <br />
                                                                        <span
                                    ...
                                    <td>
                                         <table width="650" border="0" cellpadding="0" cellspacing="0"
                                            ...
                                            <tbody>
                                                ...
                                                @foreach ($fetch_data->details as $sdata)
                                                    <tr>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td
                                                        ...
                                                        <strong> ₹{{ $fetch_data->round_off_amount }}</strong>
                                                    </td>
                                                </tr>
...
<script>
    ...
    function printthispage() {
        var invoiceElement = document.getElementById('purchaes');
        var purchaesNumberWithoutHash = null;

        if (invoiceElement) {
            purchaesNumberWithoutHash = invoiceElement.textContent.trim();
            purchaesNumberWithoutHash = purchaesNumberWithoutHash.replace('#', '');
        }
        ...
        var filename = "I&CA_" + purchaesNumberWithoutHash + "_" + ymdFormat;
