                ...
                <tr>
                    <td tyle="padding-bottom: 15px; border-top: 1px solid #e4e4e4;">
                      <p style="font-family: Helvetica, sans-serif; font-size: 17px; font-weight: normal; margin: 0; margin-bottom: 16px;">Dear {{$maildata['name']}},</p>
                        <p style="font-family: Helvetica, sans-serif; font-size: 17px; font-weight: normal; margin: 0; margin-bottom: 16px; margin-top: 10px;">Welcome to {{$maildata['app_name']}}! Your registration is successful. Your phone number {{$maildata['phone']}} is now verified and can be used across all {{$maildata['app_name']}} stores.
                          </p>
                    </td>
                </tr>
                <tr>
