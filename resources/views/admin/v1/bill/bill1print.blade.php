                                                    ...
                                                    <td>
                                                        <table width="100%" border="0" cellpadding="0"
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    <td align="left"
                                                                        ...
                                                                        <br/>
                                                                        <span style="padding: 0.25em 0.6em; color:#fff; border-radius:0.25rem; background-color:#0f75d1; font-size: 13px;
                                                            margin-top: 10px;
                                                            display: inline-block;">
                                                                ...
                                                                <tr>
                                                                    <td style="padding-right:10px; font-size: 13px; font-weight: 500; color: #1a1919; font-family: 'Open Sans', sans-serif; line-height: 1; vertical-align: top;"
                                                                       >
                                                                        <strong>Transaction No :</strong> <br> <span id="">{{$saledata->salepayament->trancaction_no}}</span>
                                                                    </td>
                                                                    <td style="padding-right:10px; font-size: 13px; font-weight: 500; color: #1a1919; font-family: 'Open Sans', sans-serif; line-height: 1; vertical-align: top;"
                                                                       >
                                                                        <strong>DOP :</strong> <br> <span id="">{{$saledata->salepayament->created_at->format('y-m-d')}}</span>
                                                                    </td>
                                                                    <td style="padding-right:10px; font-size: 13px; font-weight: 500; color: #1a1919; font-family: 'Open Sans', sans-serif; line-height: 1; vertical-align: top;"
                                                                    >
                                                                        <strong>MOP :</strong> <br> <span id="">{{$saledata->salepayament->payament_mode}} ({{$saledata->salepayament->payaments_type}})</span>
                                                                    </td>
                                                                </tr>
                                        ...
                                        <table width="650" border="0" cellpadding="0" cellspacing="0"
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td
                                                        style="font-size: 13px; font-family: 'Open Sans', sans-serif; color: #1a1919; line-height: 27px; vertical-align: top; text-align:right; ">
                                                        <strong>Tax ({{ $saledata->tax_percentage }}%)</strong>
                                                    </td>
                                                    <td
                                                        style="font-size: 13px; font-family: 'Open Sans', sans-serif; color: #1a1919; line-height: 27px; vertical-align: top; text-align:right; ">
                                                        ₹{{ $saledata->total_tax }}
