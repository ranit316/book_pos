<div class="preloader">
        <div class="loader">
            <div class="ytp-spinner">
                <img src="https://php-dev1.timdgroup.in/wp_3/wp-content/themes/ica_book_store/ica_book_store/assets/images/logo.png" alt="Logo">
...
<header id="page-topbar" class="pos-header mb-3">
    <div class="navbar-header">
        <div class="d-flex">
            ...
            <button type="button" class="btn btn-sm px-3 header-item vertical-menu-btn noti-icon" id="dashboard_button">
                <i class="bx bxs-dashboard font-size-16"></i>
            </button>
        ...
        <div class="d-flex align-items-center">
            ...
            <div class="dropdown d-inline-block">
                ...
                <button type="button" class="btn header-item noti-icon" id="print">
                    <i class="bx bx-printer icon-sm"></i>
                </button>
            </div>

            <div class="dropdown d-inline-block">
                
                <button type="button" class="btn header-item noti-icon" id="full_screen">
                    <i class="bx bx-fullscreen icon-sm"></i>
                </button>
            </div>

            <div class="dropdown d-inline-block">
                
                <button type="button" class="btn btn-primary-subtle" id="pos_unpaid">
                    <i class="bx bx-credit-card icon-sm me-1"></i><span>Make Payment</span>
                </button>
            </div>
                ...
                <div class="dropdown-menu dropdown-menu-end pt-0">
                    ...
                    <a class="dropdown-item" href="auth-lockscreen-cover.html"><i
                        ...
                        <form id="logout_form" action="{{ route('logout') }}" method="POST">
                            ...
                            <button onclick="ajaxCallwithoutheader('{{ route('logout') }}','{{ route('dashboard.show') }}')" type="button" class="dropdown-item" ><i
