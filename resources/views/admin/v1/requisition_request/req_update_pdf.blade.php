...
<div id="main_bill1">
    <div id="content_printdown">
        ...
        <input type ="hidden" value="{{$fetch_data->requisition_no}}" name="requsition" id="requsition">
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    <td align="left"
                                                                        ...
                                                                        width="50%"> <span
                                                                            style="display: block; margin-bottom: 5px;">Requisition
                                                                            No</span>
                                                                        <strong>{{$fetch_data->requisition_no}}</strong>
                                                                        <br />
                                                                        <span
                                                        ...
                                                        <table width="100%" border="0" cellpadding="0"
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    <td
                                                                        style="font-size: 13px; color: #1a1919; font-family: 'Open Sans', sans-serif; line-height: 23px;">
                                                                        Requisition Approved date: {{ $fetch_data->requisition_date }}</td>
                                                                    <td
...
<script>
    ...
    function printthispage() {
        var invoiceElement = document.getElementById('requsition');
