                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                ...
                                <div class="card-header d-flex justify-content-between">
                                    ...
                                    <a class="btn btn-success btn-rounded waves-effect waves-light mb-2 me-2" type="button" data-bs-toggle="modal" data-bs-target="#staticBackdrop"><i class="mdi mdi-plus me-1"></i>Add
                                        {{ $pagename }}</a>
                                </div>
