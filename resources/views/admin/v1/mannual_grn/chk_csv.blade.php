                                ...
                                <table class="table table-hover">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="wp-20">Publisher ID</th>
                                            ...
                                            <th class="wp-15 text-right">Req Qty</th>
                                             ...
                                             <th class="wp-15 text-right">Storage site id </th>
                                             <th class="wp-15 text-right">Storage location id </th>
                                             <th class="wp-15 text-right">Rack id </th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{$csvdata->req_qty}}</td>                                             
                                            <td>{{$csvdata->batch_no}}</td> 
                                            
                                            <td>{{$csvdata->storage_site_id}}</td> 
                                            <td>{{$csvdata->storage_location_id}}</td> 
                                            <td>{{$csvdata->rack_id}}</td> 
                                        </tr>
                                        @endforeach
                                       @else
