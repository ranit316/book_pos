              ...
              <tbody><tr>
                ...
                <tr>
                    <td tyle="padding-bottom: 15px; border-top: 1px solid #e4e4e4;">
                      ...
                      <p style="font-family: Helvetica, sans-serif; font-size: 17px; font-weight: normal; margin: 0; margin-bottom: 16px;">Dear {{$maildata['pub_name']}},</p>
                        <p style="font-family: Helvetica, sans-serif; font-size: 17px; font-weight: normal; margin: 0; margin-bottom: 16px; margin-top: 10px;">   We have observed that the stock for your book {{$maildata['book_name']}} at {{$maildata['store_name']}} is running low. Please consider replenishing the inventory.
                          </p>
                    </td>
                </tr>
                <tr>
