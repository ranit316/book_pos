            ...
            <table role="presentation" border="0" cellpadding="0" cellspacing="0" class="main" style="border-collapse: separate; mso-table-lspace: 0pt; mso-table-rspace: 0pt; background: #ffffff; border: 1px solid #eaebed; border-radius: 16px; width: 100%; padding: 24px;" width="100%">
              ...
              <tbody><tr>
                <td class="wrapper" style="font-family: Helvetica, sans-serif; font-size: 16px; vertical-align: top; box-sizing: border-box; padding-bottom: 15px; border-bottom: 1px solid #e4e4e4;" valign="top">
                    <img src="{{ asset('/assets/images/logo-sm.svg') }}" width="200">
                ...
                <tr>
                    <td tyle="padding-bottom: 15px; border-top: 1px solid #e4e4e4;">
                      ...
                      <p style="font-family: Helvetica, sans-serif; font-size: 17px; font-weight: normal; margin: 0; margin-bottom: 16px;">Dear {{$maildata['title']}},</p>
                        <p style="font-family: Helvetica, sans-serif; font-size: 17px; font-weight: normal; margin: 0; margin-bottom: 16px; margin-top: 10px;">We are pleased to inform you that a Goods Received Note (GRN) has been generated for your books at {#store_name#}.</p>
                    </td>
                </tr>
                <tr>
                    <td height="20"></td>
                  ...
                  {{-- <tr>
                    <td>
                        <p>Please use the provided credentials to log in to your account via our website https://pos.wbicabooks.com/. Once logged in, you'll have access to a range of features tailored to your role.
                          .</p>
                        <p>If you have any questions or need assistance, feel free to contact our support team at tech-support@wbicabooks.com. We're here to help!
                        .</p>
                    </td>
                  </tr> --}}
                <tr>
