                ...
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            <select id="state_id" required class="form-control"
                                name="state_id" disabled>
                        ...
                        <div class="form-group">
                            ...
                            <select id="district_id" required type="text" class="form-control" placeholder="Enter  District "
                                ...
                                @if (auth()->user()->type == 'admin' || auth()->user()->type == 'supplier')
                                    <option {{ $data->type == 'central-store' ? 'selected' : '' }} value="central-store">Central Store
                                    </option>
                                @endif
                                <option {{ $data->type == 'retail-store' ? 'selected' : '' }} value="retail-store">Retail Store</option>
                            </select>
                        </div>
                    </div>
                    ...
                    @if (auth()->user()->type == 'admin')
                        ...
                        @if ($data->type == 'central-store')
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    <label for="publisher_id" class="">Publisher</label>
                                    <select id="publisher_id"  class="form-control"  name="publisher_id" disabled>
                                    
                                        @foreach ($publishers as $publisher)
                                        @if($publisher->user)
                                            <option value="{{ $publisher->id }}" {{ ($user->parent_id == $publisher->user->id) ? 'selected' : '' }}>
                    ...
                    @endif
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <input required type="number" placeholder="Enter Pin Code"
                                             maxlength ="6"  onkeyup="maxnumvalidate(this.value,'pin_code2',6);"  data-max-chars="6"
                                            class="form-control" name="pin_code" id="pin_code2" value="{{ $data->pin_code }}" >
                                    </div>
                                </div>
                                <div class="col-sm-4">
                                    <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <div class="form-group">
                                        ...
                                        <textarea required id="address"     class="form-control" placeholder="Enter address Name" name="address">{{ $data->address }}</textarea>
                                    </div>
                                </div>
                                ...
                                <div class ="row">
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" placeholder="Enter Billing details" name="billing_header">{{ ($setting!='')?$setting->value:'' }}</textarea>
                                        </div>
                                    </div>
