                                                        ...
                                                        @foreach ($data->details as $p)
                                                            <tr id="row{{ $loop->index + 1 }}">
                                                                ...
                                                                <td width="18%"><select
                                                                        ...
                                                                        data-live-search="true" id="price_0" readonly disabled>
                                                                ...
                                                                <td><input onkeyup="qtyCal()" onclick="qtyCal()"
                                                                        ...
                                                                        class="form-control-sm form-control request_qty" readonly  />
                                                                </td>
                                                                ...
                                                                <td><input onkeyup="qtyCal()" onclick="qtyCal()"
                                                                        ...
                                                                        placeholder="taxeble_amount" readonly
                                                                ...
                                                                <input onkeyup="qtyCal()" onclick="qtyCal()"
                                                                        ...
                                                                        placeholder="total_amount" readonly
