                                                                ...
                                                                <tr>
                                                                    <td style="padding-right:10px; font-size: 13px; font-weight: 500; color: #1a1919; font-family: 'Open Sans', sans-serif; line-height: 1; vertical-align: top;"
                                                                       >
                                                                        ...
                                                                        <strong>Transaction No :</strong> <br> <span id="tran_no"></span>
 
                                                                    </td>
                                                                    <td style="padding-right:10px; font-size: 13px; font-weight: 500; color: #1a1919; font-family: 'Open Sans', sans-serif; line-height: 1; vertical-align: top;"
                                                                       >
                                                                        <strong>DOP :</strong> <br> <span id="date_payment"></span>
                                                                    </td>
                                                                    <td style="padding-right:10px; font-size: 13px; font-weight: 500; color: #1a1919; font-family: 'Open Sans', sans-serif; line-height: 1; vertical-align: top;"
                                                                    >
                                                                        <strong>MOP :</strong> <br> <span id="mode_payment"></span>
                                                                    </td>
                                                                </tr>
                                                                {{-- <tr>
                                ...
                                <div class="col-md-12">
                                    <div class="mb-3 position-relative">
                                        ...
                                        <input required type="text" class="form-control" name="voucher_no"
                                            id="voucher_no" placeholder="Voucher/Transaction No" value=""><div
                                            class="text-danger" id="voucher_no_error"></div>
