                                            ...
                                            <table width="100%" border="0" cellpadding="0" cellspacing="0"
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td align="right"><img src={{ $logo->logo }} width="200">
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td height="40"></td>
                                                    ...
                                                    <table width="100%" border="0" cellpadding="0"
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr id="print_btn">
                                                                <td>
                                                                    <button type="button"
                                                                        class="btn btn-primary me-4 mt-5"
                                                                        id="print_bill"
                                                                        onclick="printthispage(this)">Print
                                                                        Bill</button>
                                                                <td>
                                                            </tr>
                                                    </table>
...
<script>
    function printthispage(divId) {
        ...
        var printContents = document.querySelector("#main_bill").innerHTML;
