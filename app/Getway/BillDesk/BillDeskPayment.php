...
class BillDeskPayment
{
    ...
    private static $clientId = 'icadwbp';
    public static  $amount = "3000.00";
    public  static $CALLBACK_URL ;
    private const PAYMENT_URL = "https://api.billdesk.com/payments/ve1_2/orders/create";
    public static $checksumKey = "gPMQeXr7hessCEN0Lrr3o09sE8evpQ3z";
    ...
    public static function  initPayment($amount, array $addinationInfo, array $splitPayemnt,)
    {
        ...
        $curl_payload = [
            "mercid" => 'ICADWBP', // your merchantid given by billdesk
