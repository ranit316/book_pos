                    ...
                    <div class="card">
                        ...
                        <div class="card-header d-flex justify-content-between">
                            <div class="header-title">
                                <h4 class="card-title text-capitalize">Edit Publisher</h4>
                            </div>
...
{{-- 
                        ...
                        <div class="card-body">
                            <form id="form_data" action="{{route('pub.update',[$edit->id])}}" method="POST"
                                >
                                @csrf
                                <div class="row">
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="store_name" value="{{$edit->store_name}}">
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <div class="form-group col-sm-4">
                                        ...
                                        <select id="district_id" required type="text" class="form-control"
                                            ...
                                            <option selected disabled> {{$edit->district->name}} </option>
                                            @foreach ($dis as $di)
