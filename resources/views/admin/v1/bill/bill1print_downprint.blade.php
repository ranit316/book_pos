                                                                ...
                                                                <tr>
                                                                    <td align="left"
                                                                        ...
                                                                        width="50%"> <span
                                                                            ...
                                                                            Invoice</span>
                                                                        <strong
                                                                            id="invoice">#{{ $saledata->invoice_no }}</strong>
                                                                        <br />
                                                                        <span
                    ...
                    <div class="card-body">
                        ...
                        <form class="needs-validation" id="offline_data" action="{{ route('cashpayment.pos') }}"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="mb-3 position-relative">
                                        ...
                                        <label class="form-label required"
                                            for="validationTooltip02">Voucher/Transaction No</label>
                                        <input required type="text" class="form-control" name="voucher_no"
                                            id="validationTooltip02" placeholder="Voucher/Transaction No"
                                            value="">
                                ...
                                <div class="col-md-12">
                                    <div class="mb-3 position-relative">
                                        <label class="form-label required" for="validationTooltip02">Payament
                                            Mode</label>
...
<script>
    function printthispage() {
        ...
        var filename = "I&CA_" + invoiceNumberWithoutHash + "_" + ymdFormat;
    ...
    //             // Add the image to the PDF, scaling it to fit A4 dimensions
