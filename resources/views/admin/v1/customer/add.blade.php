                                                ...
                                                <div class="col-sm-4 d-flex align-items-center">
                                                    <div class="f-group">
                                                        ...
                                                        <button type="button" class="btn btn-success btn-rounded"
                                                            id="chk_btn" onclick='checkcustomer()'><i
                                                                class="uil uil-check me-2"></i>Check
                                                            Customer</button>
                                                    </div>
                                                </div>
                                        ...
                                        @enderror
                                                ...
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                                        ...
                                                        <select id="state" required type="text"
                                        ...
                                        ?>
                                                ...
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number" name="pincode" id="pincode"
                                                            value="{{ old('pincode') }}" class="form-control limitedTxt"
                                                ...
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                                        ...
                                                        <select id="country" required type="text"
                                                            class="form-control selectpicker" data-live-search="true"
                                                            name="country">
                                                ...
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number" name="gst_no" id="gst_no"
                                                            value="{{ old('gst_no') }}" class="form-control"
