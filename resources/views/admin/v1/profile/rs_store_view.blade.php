                            ...
                            <div class="card">
                                ...
                                <div class="card-header d-flex justify-content-between">
                                    <div class="header-title">
                                        <h4 class="card-title">Retail Store Edit</h4>
                                    </div>  
                                </div>

                                <div class="card-body">
                                
                                <form action="{{ route('profile.rs.update',[$store->id])}}" name="app_setting" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    <div class= "row">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label class="required">Store Name</label>
                                            <input type="text" class="form-control" placeholder="Enter Name" name="name" value="{{$store->store_name }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <select id="district" required class="form-control selectpicker" data-live-search="true" name="district">
                                                ...
                                                <option value="{{ $district->id }}" {{ $store->district_id == $district->id ? 'selected' : '' }}>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" placeholder="Enter Name" name="address" value="{{$store->address }}" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            value="{{ $store->logo_image ?? '' }}" name="logo"
                                            id="app_logo">
                                        @if (!empty($store->logo_image))
                                            <img src="{{ url($store->logo_image) }}"
