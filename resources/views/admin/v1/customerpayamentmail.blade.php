            ...
            <tr>
              ...
              <tr>
                  <td tyle="padding-bottom: 15px; border-top: 1px solid #e4e4e4;">
                    ...
                    <p style="font-family: Helvetica, sans-serif; font-size: 17px; font-weight: normal; margin: 0; margin-bottom: 16px; margin-top: 10px;">Your payment of {{$maildata['total']}} for Order ID: {{$maildata['total']}} at  {{optional(DB::table('app_infos')->first())->title}} has been successful.</p>
                  </td>
              </tr>
              <tr>
                  <td height="20">
                    <p style="font-family: Helvetica, sans-serif; font-size: 17px; font-weight: normal; margin: 0; margin-bottom: 16px;">Thank you for your purchase. Please find the attached bill.</p>
                  </td>
              </tr>
      {{-- <tr>
            ...
            <td>
                ...
                <tbody>
                  ...
                  <tr>
                    <td style="font-size: 14px; font-family: 'Open Sans', sans-serif; color: #1a1919; line-height: 23px; vertical-align: top; padding:10px; border-bottom: 1px solid #e4e4e4;" class="article">
                      ...
                      <td style="font-size: 14px; font-family: 'Open Sans', sans-serif; color: #1a1919;  line-height: 23px;  vertical-align: top; padding:10px; border-bottom: 1px solid #e4e4e4;" align="right">central</td>
                  </tr>
                  <tr>
                    <td style="font-size: 14px; font-family: 'Open Sans', sans-serif; color: #1a1919; line-height: 23px; vertical-align: top; padding:10px; border-bottom: 1px solid #e4e4e4;" class="article">
               ...
               <tr>
                ...
                {{-- <tr>
                  <td>
                      ...
                      <p>We would also greatly appreciate your feedback on your shopping experience. Please take a moment to share your thoughts by clicking https://www.wbicabooks.com/share-feedback?orderid={{$maildata['invoice_no']}}.</p>
              ...
              {{-- <tr>
                  ...
                  <span style="color:#141823;font-size:14px;font-weight:normal;line-height:24px;font-family:Helvetica Neue,Helvetica,Lucida Grande,tahoma,verdana,arial,sans-serif"><a style="color:#1b74e4;text-decoration:none" href=""> support.ica.govt@gmail.com</a></span>
